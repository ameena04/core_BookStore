...
namespace coreBookStoreApi.Migrations
{
    ...
    [Migration("20190422061040_initialcreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("coreBookStoreApi.Models.Admin", b =>
                {
            ...
            modelBuilder.Entity("coreBookStoreApi.Models.Author", b =>
                {
            ...
            modelBuilder.Entity("coreBookStoreApi.Models.Book", b =>
                {
            ...
            modelBuilder.Entity("coreBookStoreApi.Models.BookCategory", b =>
                {
                    b.Property<int>("BookCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("coreBookStoreApi.Models.OrderBook", b =>
                {
                    b.Property<int>("OrderId");
            ...
            modelBuilder.Entity("coreBookStoreApi.Models.Publication", b =>
                {
                    b.Property<int>("PublicationId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("coreBookStoreApi.Models.Review", b =>
                {
                    b.Property<int>("ReviewId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("coreBookStoreApi.Models.Book", b =>
                {
                    b.HasOne("coreBookStoreApi.Models.Author", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("coreBookStoreApi.Models.BookCategory", "BookCategory")
                        .WithMany("Books")
                        .HasForeignKey("BookCategoryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("coreBookStoreApi.Models.Publication", "Publication")
                        .WithMany("Books")
